...
export const BUILT_IN_POLICIES: PolicyData[] = [
  { name: 'DIRECT', type: 'built-in', description: '直连，不使用代理', category: 'basic' },
  { name: 'PROXY', type: 'built-in', description: '使用代理服务器', category: 'basic' },
  { name: 'REJECT', type: 'built-in', description: '拒绝连接', category: 'basic' },
  { name: 'PASS', type: 'built-in', description: '跳过当前规则', category: 'basic' },
];
...
export const NETWORK_TYPES: NetworkTypeData[] = [
  // 传输层协议
  { type: 'TCP', description: 'Transmission Control Protocol', category: 'transport' },
  { type: 'UDP', description: 'User Datagram Protocol', category: 'transport' },
  { type: 'ICMP', description: 'Internet Control Message Protocol', category: 'transport' },
  { type: 'SCTP', description: 'Stream Control Transmission Protocol', category: 'transport' },
  
  // 应用层协议
  { type: 'HTTP', description: 'HyperText Transfer Protocol', category: 'application' },
  { type: 'HTTPS', description: 'HTTP Secure', category: 'application' },
  { type: 'FTP', description: 'File Transfer Protocol', category: 'application' },
  { type: 'SMTP', description: 'Simple Mail Transfer Protocol', category: 'application' },
  { type: 'POP3', description: 'Post Office Protocol 3', category: 'application' },
  { type: 'IMAP', description: 'Internet Message Access Protocol', category: 'application' },
  { type: 'DNS', description: 'Domain Name System', category: 'application' },
  { type: 'DHCP', description: 'Dynamic Host Configuration Protocol', category: 'application' },
  { type: 'SSH', description: 'Secure Shell', category: 'application' },
  { type: 'TELNET', description: 'Telnet Protocol', category: 'application' },
  { type: 'SNMP', description: 'Simple Network Management Protocol', category: 'application' },
  ...
  { type: 'PPTP', description: 'Point-to-Point Tunneling Protocol', category: 'tunnel' },
  { type: 'L2TP', description: 'Layer 2 Tunneling Protocol', category: 'tunnel' },
  { type: 'IPSEC', description: 'Internet Protocol Security', category: 'tunnel' },
];

// 常用域名后缀
export const COMMON_DOMAIN_SUFFIXES = [
  'com', 'org', 'net', 'edu', 'gov', 'mil', 'int',
  'cn', 'jp', 'kr', 'hk', 'tw', 'sg', 'my', 'th', 'id', 'ph', 'vn',
  'us', 'ca', 'mx', 'br', 'ar',
  'uk', 'de', 'fr', 'it', 'es', 'nl', 'ch', 'se', 'no', 'fi', 'dk', 'ru',
  'au', 'nz',
  'io', 'co', 'me', 'tv', 'cc', 'biz', 'info', 'name', 'pro',
];
...
export const COMMON_PROCESSES = [
  // 浏览器
  'chrome.exe', 'firefox.exe', 'edge.exe', 'safari.exe', 'opera.exe', 'brave.exe',
  ...
  // 网络工具
  'curl.exe', 'wget.exe', 'aria2c.exe', 'thunder.exe', 'qbittorrent.exe',
  'utorrent.exe', 'bittorrent.exe', 'transmission.exe',
  
  // 通讯软件
  'wechat.exe', 'qq.exe', 'telegram.exe', 'discord.exe', 'slack.exe',
  'teams.exe', 'zoom.exe', 'skype.exe', 'whatsapp.exe',
  ...
  'battlenet.exe', 'gog.exe', 'minecraft.exe',
];
